...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col relative lg:flex-row bg-gradient-to-tr from-[#232526] to-[#414345] text-white p-4 sm:p-6 overflow-hidden">
      ...
      {message && (
        <div
          className={`fixed z-50 flex items-center justify-between w-[90%] max-w-4xl px-4 py-3 rounded-lg shadow-lg border ${
            messageType === "error"
              ? "bg-red-500/20 text-red-400 border-red-400/30"
              : "bg-green-500/20 text-green-400 border-green-400/30"
          } top-[9%] transform -translate-x-1/2 -translate-y-1/2 left-1/2 sm:top-[8%] md:top-6 `}
        >
